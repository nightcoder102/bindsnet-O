...
inh= 17.5 #inhibitatory to excitatory weight connection
theta_plus=0.05 # increase of membrane voltage per spike
time=700 # time of image exposition
...
params = get_STDP_param_from_data(dir_path = os.path.expanduser("~/data"),pn='Pulse number', cn= 'Conductance',
            reduceDataSize = 70,filterOn=True,useLinearRegressionMethod= False,useSTDP=False,plot=True)
"""
